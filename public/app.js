...
const dinosaurs = [
    ...
    // ======================
    {
        ...
        prime: {
            ...
            {x:25,y:12.6},{x:30,y:18.1},{x:35,y:23.2},{x:40,y:28.5},{x:45,y:33.7},
            {x:50,y:36},{x:55,y:35.7},{x:60,y:35.1},{x:65,y:34.5},{x:70,y:34.2},
            {x:75,y:34.2},{x:80,y:36.6},{x:85,y:37.7},{x:90,y:37.8},{x:95,y:37.1},
            {x:100,y:32.4}
        ]
        },
        frail: {
            ...
            {x:25,y:12.6},{x:30,y:18.1},{x:35,y:23.2},{x:40,y:28.5},{x:45,y:33.7},
            {x:50,y:36},{x:55,y:35.7},{x:60,y:35.1},{x:65,y:34.5},{x:70,y:34.2},
            {x:75,y:34.2},{x:80,y:34.2},{x:85,y:34.2},{x:90,y:34.2},{x:95,y:33.1},
            {x:100,y:28.8}
        ]
        }, 
    ...
    },
    {
        ...
        prime: {
            ...
            data: [
            {x:0,y:null},{x:5,y:null},{x:10,y:null},{x:15,y:null},{x:20,y:null},
            {x:25,y:21.9},{x:30,y:27},{x:35,y:31.9},{x:40,y:35.4},{x:45,y:37.8},
            {x:50,y:40.1},{x:55,y:41.6},{x:60,y:43},{x:65,y:44},{x:70,y:44.5},
            {x:75,y:45},{x:80,y:47},{x:85,y:49.9},{x:90,y:50.4},{x:95,y:48.3},
            {x:100,y:39.6}
        ]
        },
        frail: {
            ...
            {x:25,y:21.9},{x:30,y:27},{x:35,y:31.9},{x:40,y:35.4},{x:45,y:37.8},
            {x:50,y:40.1},{x:55,y:41.6},{x:60,y:43},{x:65,y:44},{x:70,y:44.5},
            {x:75,y:45},{x:80,y:45.1},{x:85,y:44.6},{x:90,y:42.9},{x:95,y:39},
            {x:100,y:32.4}
        ]
        },
    },
    {
        ...
        prime: {
            ...
            data: [
            {x:0,y:null},{x:5,y:null},{x:10,y:null},{x:15,y:null},{x:20,y:null},
            {x:25,y:11.9},{x:30,y:17.3},{x:35,y:22.5},{x:40,y:26.3},{x:45,y:28.8},
            {x:50,y:31.3},{x:55,y:33.2},{x:60,y:35.1},{x:65,y:36.8},{x:70,y:38.2},
            {x:75,y:39.6},{x:80,y:39.9},{x:85,y:39.8},{x:90,y:39.3},{x:95,y:38.3},
            {x:100,y:37.8}
        ]
        },
        frail: {
            ...
            {x:25,y:11.9},{x:30,y:17.3},{x:35,y:22.5},{x:40,y:26.3},{x:45,y:28.8},
            {x:50,y:31.3},{x:55,y:33.2},{x:60,y:35.1},{x:65,y:36.8},{x:70,y:38.2},
            {x:75,y:39.6},{x:80,y:38.1},{x:85,y:35.8},{x:90,y:33.3},{x:95,y:31.4},
            {x:100,y:30.6}
        ]
        },
    },
    {
        ...
        prime: {
            ...
            data: [
            {x:0,y:null},{x:5,y:null},{x:10,y:null},{x:15,y:null},{x:20,y:null},
            {x:25,y:17.9},{x:30,y:19.5},{x:35,y:23.5},{x:40,y:29.3},{x:45,y:36.4},
            {x:50,y:44.1},{x:55,y:43.5},{x:60,y:42.4},{x:65,y:41.1},{x:70,y:40},
            {x:75,y:39.6},{x:80,y:39.6},{x:85,y:39.6},{x:90,y:39.4},{x:95,y:38.4},
            {x:100,y:37.8}
        ]
        },
        frail: {
            ...
            {x:25,y:17.9},{x:30,y:19.5},{x:35,y:23.5},{x:40,y:29.3},{x:45,y:36.4},
            {x:50,y:44.1},{x:55,y:43.5},{x:60,y:42.4},{x:65,y:41.1},{x:70,y:40},
            {x:75,y:39.6},{x:80,y:39.6},{x:85,y:39.4},{x:90,y:38.6},{x:95,y:36.9},
            {x:100,y:34.2}
        ]
        },
    },
    {
        ...
        prime: {
            ...
            data: [
            {x:0,y:null},{x:5,y:null},{x:10,y:null},{x:15,y:null},{x:20,y:null},
            {x:25,y:19.5},{x:30,y:22.9},{x:35,y:27.8},{x:40,y:34.1},{x:45,y:42.7},
            {x:50,y:46.9},{x:55,y:46.4},{x:60,y:45.3},{x:65,y:43.9},{x:70,y:42.8},
            {x:75,y:42.3},{x:80,y:41.9},{x:85,y:40.7},{x:90,y:39.4},{x:95,y:38.3},
            {x:100,y:37.8}
        ]
        },
        frail: {
            ...
            {x:25,y:19.5},{x:30,y:22.9},{x:35,y:27.8},{x:40,y:34.1},{x:45,y:42.7},
            {x:50,y:46.9},{x:55,y:46.4},{x:60,y:45.3},{x:65,y:43.9},{x:70,y:42.8},
            {x:75,y:42.3},{x:80,y:41.6},{x:85,y:40},{x:90,y:38.4},{x:95,y:36.6},
            {x:100,y:36}
        ]
        },
    },
    {
        ...
        prime: {
            ...
            data: [
            {x:0,y:null},{x:5,y:null},{x:10,y:null},{x:15,y:null},{x:20,y:null},
            {x:25,y:23.4},{x:30,y:31.8},{x:35,y:39.8},{x:40,y:44.5},{x:45,y:46.2},
            {x:50,y:47.9},{x:55,y:47.3},{x:60,y:46.7},{x:65,y:45.8},{x:70,y:43.3},
            {x:75,y:41.8},{x:80,y:43.6},{x:85,y:46.1},{x:90,y:46.6},{x:95,y:45.4},
            {x:100,y:39.6}
        ]
        },
        frail: {
            ...
            {x:25,y:23.4},{x:30,y:31.8},{x:35,y:39.8},{x:40,y:44.5},{x:45,y:46.2},
            {x:50,y:47.9},{x:55,y:47.3},{x:60,y:46.7},{x:65,y:45.8},{x:70,y:43.3},
            {x:75,y:41.8},{x:80,y:41.8},{x:85,y:41.8},{x:90,y:41.5},{x:95,y:38.8},
            {x:100,y:30.6}
        ]
        },
    },
    ...
    },
    {
        ...
        prime: {
            ...
            data: [
            {x:0,y:null},{x:5,y:null},{x:10,y:null},{x:15,y:null},{x:20,y:null},
            {x:25,y:8.6},{x:30,y:12.5},{x:35,y:16.2},{x:40,y:18.9},{x:45,y:20.7},
            {x:50,y:22.5},{x:55,y:23.9},{x:60,y:25.3},{x:65,y:28.5},{x:70,y:33.2},
            {x:75,y:37.8},{x:80,y:39},{x:85,y:39.6},{x:90,y:38.7},{x:95,y:36.3},
            {x:100,y:35.1}
        ]
        },
        frail: {
            ...
            {x:25,y:8.6},{x:30,y:12.5},{x:35,y:16.2},{x:40,y:18.9},{x:45,y:20.7},
            {x:50,y:22.5},{x:55,y:23.9},{x:60,y:25.3},{x:65,y:28.5},{x:70,y:33.2},
            {x:75,y:37.8},{x:80,y:37.8},{x:85,y:37.8},{x:90,y:35.9},{x:95,y:31.2},
            {x:100,y:28.5}
        ]
        },
    },
